...
import At from '/Users/siddharthraj/Desktop/my-portfolio/public/At.png'
import linkedin from '/Users/siddharthraj/Desktop/my-portfolio/public/linkedin.png'
import facebook from '/Users/siddharthraj/Desktop/my-portfolio/public/facebook.png'
import instagram from '/Users/siddharthraj/Desktop/my-portfolio/public/instagram.png'
import github from '/Users/siddharthraj/Desktop/my-portfolio/public/github.png'
import imghero from '/Users/siddharthraj/Desktop/my-portfolio/public/imghero.png'
import Sid from '/Users/siddharthraj/Desktop/my-portfolio/public/Sid_cv1.pdf'
import Hero from '/Users/siddharthraj/Desktop/my-portfolio/public/imghero.png'
function MainPage() {
  return (
        ...
        <main id="home" className='flex flex-col md:flex-row items-center justify-center w-full px-4 md:px-52 pb-4 md:pb-24 md:pt-32 pt-24 mt-14 md:mt-0 z-10'>
            <section className='flex-1 mr-28 md:text-left mt-10 md:mt-0 relative' data-aos='fade-up' data-aos-delay='500'>
                ...
                <header>
                    ...
                    <h2 className='text-xl sm:text-4xl md:text-2xl font-bold text-[#3e0f4a] md:text-[#c744ec] mb-2'>CSE Major</h2>
                </header>
